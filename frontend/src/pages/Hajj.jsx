    ...
    <>
      ...
      >
        ...
        <div className="mb-12 text-center">
          <h1 className="inline-block px-4 py-2 text-3xl font-extrabold text-orange-600 bg-white/50 rounded-[20px] shadow-lg backdrop-blur-sm border-[3px] border-blue-500 sm:text-4xl">
            Holy Umrah Packages
          </h1>
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ -৬০০মিঃ এবং মদিনা শরীফ -৭০০মিঃ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সরাসরি ফ্লাইট (বিমান বাংলাদেশ/ইউএস বাংলা/সৌদি এয়ারলাইন্স)
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ৩ বেলা মানসম্মত খাবার
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ২৪ ঘণ্টা চিকিৎসা সেবা সুবিধা
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ এক সফরে একাধিক ওমরা করার সুযোগ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ অভিজ্ঞ মোয়াল্লেম দ্বারা পরিচালনা, মক্কার ও মদিনার ঐতিহাসিক
                  স্থান ভ্রমণ
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ -৩৫০মিঃ এবং মদিনা শরীফ -৪০০মিঃ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সরাসরি ফ্লাইট (সৌদি এয়ারলাইন্স الخطوط السعودية)
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ৩ বেলা মানসম্মত খাবার
                </li>
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ -০মিঃ এবং মদিনা শরীফ -০মিঃ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সরাসরি ফ্লাইট (সৌদি এয়ারলাইন্স الخطوط السعودية)
                </li>
        ...
        <div className="mt-16 mb-12 text-center">
          <h2 className="inline-block px-4 py-2 text-3xl font-extrabold text-orange-600 bg-white/50 rounded-[20px] shadow-lg backdrop-blur-sm border-[3px] border-blue-500 sm:text-4xl">
            Holy Hajj Packages
          </h2>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ ৫০০মিঃ/১০০০মিঃ ও মদিনা শরীফ ৮০০
                  মিটার
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সম্পূর্ণ এয়ারকন্ডিশন (এসি) সম্বলিত উন্নতমানের আবাসন
                  ব্যবস্থা
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সরাসরি ফ্লাইট (সৌদি এয়ারলাইন্স الخطوط السعودية)
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ রুচিসম্মত (দুই বেলা) দেশীয় খাবার।
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ২৪ ঘণ্টা চিকিৎসা সেবা সুবিধা
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ‌ প্রতি রুমে ৪/৬ জন আলাদা ওয়াশরুমের সুবিধা
                </li>
                <li className="flex items-center gap-2 text-left">
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ ৫০০মিঃ/১০০০মিঃ ও মদিনা শরীফ ৪০০মিঃ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সম্পূর্ণ এয়ারকন্ডিশন (এসি) সম্বলিত উন্নতমানের আবাসন
                  ব্যবস্থা
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ রুচিসম্মত (তিন বেলা) দেশীয় খাবার।
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ২৪ ঘণ্টা চিকিৎসা সেবা সুবিধা
                </li>
          ...
          <div className="flex flex-col justify-between p-6 bg-white border border-gray-200 shadow-lg rounded-[20px] hover:shadow-xl group">
            <div>
              ...
              <ul className="mt-6 space-y-2 text-gray-700">
                <li className="flex items-center gap-2 text-left">
                  ✅ হোটেল দূরত্ব: মক্কা শরীফ ০মিঃ ও মদিনা শরীফ ০মিঃ
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ সম্পূর্ণ এয়ারকন্ডিশন (এসি) সম্বলিত উন্নতমানের আবাসন
                  ব্যবস্থা
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ নিজস্ব চাহিদা অনুসারে নিজস্ব বাবুর্চি দ্বারা রুচিসম্মত
                  দেশীয় খাবার।
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ ২৪ ঘণ্টা চিকিৎসা সেবা সুবিধা
                ...
                <li className="flex items-center gap-2 text-left">
                  ✅ ‌‌ নিজস্ব চাহিদা অনুসারে যাবতীয় সেবা প্রদান করা হবে।
                </li>
                <li className="flex items-center gap-2 text-left">
                  ✅ অভিজ্ঞ মোয়াল্লেম দ্বারা পরিচালনা
                </li>
